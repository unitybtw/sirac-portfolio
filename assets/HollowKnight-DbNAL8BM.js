import{r as l,j as e}from"./vendor-three-BKnJn67O.js";import{m as a}from"./index-DcTHaspC.js";import{Z as c}from"./GameLibrary-jkOoiDIL.js";import{M as d}from"./maximize-B-3RT4XJ.js";function g(){const[r,s]=l.useState(!0),t=l.useRef(null),i=()=>{const n=document.getElementById("hollow-game-wrapper");n&&(document.fullscreenElement?document.exitFullscreen&&document.exitFullscreen():n.requestFullscreen().catch(o=>{console.error(`Error attempting to enable full-screen mode: ${o.message} (${o.name})`)}))};return l.useEffect(()=>{r&&t.current&&t.current.focus()},[r]),e.jsx("div",{id:"hollow-game-wrapper",style:{width:"100%",height:"100%",display:"flex",flexDirection:"column",background:"#000",position:"relative"},children:r?e.jsxs("div",{style:{flex:1,position:"relative",overflow:"hidden"},children:[e.jsx("iframe",{ref:t,srcDoc:`<!DOCTYPE html>
<html lang="en-us">
<head>
    <meta charset="utf-8">
