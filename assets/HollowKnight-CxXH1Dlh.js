import{r as l,j as e,m as a}from"./index-BVX80AQs.js";import{Z as c}from"./GameLibrary-C1qdMgo0.js";import{M as d}from"./maximize-D6FHEiDz.js";function h(){const[r,s]=l.useState(!1),t=l.useRef(null),i=()=>{const n=document.getElementById("hollow-game-wrapper");n&&(document.fullscreenElement?document.exitFullscreen&&document.exitFullscreen():n.requestFullscreen().catch(o=>{console.error(`Error attempting to enable full-screen mode: ${o.message} (${o.name})`)}))};return l.useEffect(()=>{r&&t.current&&t.current.focus()},[r]),e.jsx("div",{id:"hollow-game-wrapper",style:{width:"100%",height:"100%",display:"flex",flexDirection:"column",background:"#000",position:"relative"},children:r?e.jsxs("div",{style:{flex:1,position:"relative",overflow:"hidden"},children:[e.jsx("iframe",{ref:t,srcDoc:`<!DOCTYPE html>
<html lang="en-us">
<head>
    <meta charset="utf-8">
