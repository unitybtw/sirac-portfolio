import{d as c,a as o,j as e,Q as d,V as u,O as f}from"./vendor-react-PXDl72hr.js";import{m as g}from"./vendor-framer-_P-FfMG-.js";import"./vendor-B_QIrjb_.js";import"./vendor-three-CWVKQhTc.js";function x(){const{t}=c(),[a,i]=o.useState(!1),r=o.useRef(null),l=()=>{const n=document.getElementById("gta-game-wrapper");n&&(document.fullscreenElement?document.exitFullscreen&&document.exitFullscreen():n.requestFullscreen().catch(s=>{console.error(`Error attempting to enable full-screen mode: ${s.message} (${s.name})`)}))};return o.useEffect(()=>{a&&r.current&&r.current.focus()},[a]),e.jsx("div",{id:"gta-game-wrapper",style:{width:"100%",height:"100%",display:"flex",flexDirection:"column",background:"#000",position:"relative"},children:a?e.jsxs("div",{style:{flex:1,position:"relative",overflow:"hidden"},children:[e.jsx("iframe",{ref:r,srcDoc:`<!doctype html>
<html lang="en-us">
...
</html>`,style:{width:"100%",height:"100%",border:"none"},title:"GTA Vice City Web",sandbox:"allow-scripts allow-same-origin allow-pointer-lock allow-forms blob: *",allow:"autoplay; fullscreen; keyboard-lock; pointer-lock",allowFullScreen:!0,onLoad:()=>{r.current&&r.current.focus()}}),e.jsx("button",{onClick:l,style:{position:"absolute",bottom:"10px",right:"10px",background:"rgba(0,0,0,0.5)",border:"none",color:"#fff",padding:"5px",borderRadius:"5px",cursor:"pointer",zIndex:10,backdropFilter:"blur(5px)"},children:e.jsx(f,{size:16})})]}):e.jsx("div",{style:{flex:1,display:"flex",justifyContent:"center",alignItems:"center",padding:"20px",background:"#1a0b1c"},children:e.jsxs(g.div,{initial:{opacity:0,scale:.95},animate:{opacity:1,scale:1},style:{textAlign:"center",maxWidth:"450px"},children:[e.jsx("h2",{className:"text-gradient",style:{fontSize:"2.5rem",marginBottom:"0.5rem",color:"#ff66b2",fontFamily:"serif",fontStyle:"italic",letterSpacing:"2px",textShadow:"0 0 10px #ff66b2"},children:"Vice City"}),e.jsx("p",{style:{color:"#fff",fontSize:"0.9rem",marginBottom:"1.5rem",textTransform:"uppercase",letterSpacing:"4px"},children:"Welcome to the 80s"}),e.jsxs("div",{style:{background:"rgba(255, 102, 178, 0.05)",padding:"1rem",borderRadius:"8px",border:"1px solid rgba(255, 102, 178, 0.2)",marginBottom:"1.5rem",textAlign:"left",fontSize:"0.9rem"},children:[e.jsxs("p",{style:{color:"#ff66b2",fontWeight:"bold",marginBottom:"0.3rem",display:"flex",alignItems:"center",gap:"8px"},children:[e.jsx(d,{size:16})," ",t("game_common.controls")]}),e.jsxs("p",{style:{color:"#ffcc00",fontSize:"0.8rem",fontStyle:"italic",marginBottom:"1rem"},children:["⚠️ ",t("game_launch.vc_downloading")]}),e.jsxs("ul",{style:{color:"#bbb",margin:0,paddingLeft:"1.2rem",fontSize:"0.8rem"},children:[e.jsxs("li",{children:[e.jsx("strong",{children:t("game_common.controls").includes("K")?"Ekrana tıklayarak":"Click the screen"})," ",t("game_common.controls").includes("K")?"fareyi oyun içine kilitleyin.":"to lock mouse in game."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"WASD:"})," ",t("game_launch.vc_wasd")]}),e.jsxs("li",{children:[e.jsxs("strong",{children:[t("game_common.controls").includes("K")?"Fare":"Mouse",":"]})," ",t("game_launch.vc_mouse")]}),e.jsxs("li",{children:[e.jsxs("strong",{children:[t("game_common.controls").includes("K")?"Sol Tık":"LMB",":"]})," ",t("game_launch.vc_lmb")]}),e.jsxs("li",{children:[e.jsx("strong",{children:"F / Enter:"})," ",t("game_launch.vc_f")]}),e.jsxs("li",{children:[e.jsx("strong",{children:"ESC:"})," ",t("game_common.controls").includes("K")?"Menü / Duraklat":"Menu / Pause"]})]})]}),e.jsxs("button",{onClick:()=>i(!0),className:"btn btn-primary",style:{width:"100%",padding:"1.2rem",fontSize:"1.2rem",background:"linear-gradient(45deg, #ff66b2, #00f0ff)",color:"#fff",fontWeight:"bold",borderRadius:"8px",border:"none",boxShadow:"0 0 20px rgba(255,102,178,0.5)",textTransform:"uppercase"},children:[e.jsx(u,{size:20,style:{display:"inline",marginRight:"8px"}})," ",t("game_launch.vc_btn")]})]})})})}export{x as default};
