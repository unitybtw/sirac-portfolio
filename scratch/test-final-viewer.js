...
(async () => {
  console.log('Starting final viewer/footer light mode screenshot capture...');
  ...
  for (let i = 0; i < scrollSteps.length; i++) {
    ...
    await page.waitForTimeout(2500); // Give time for 3D model canvas to initialize
